**This smart contract is used to fetch the price of ethereum(you can take any aything of your choice) by passing our own api, this use the concept of chainlink, so to test this you need the following** \
Setup Requirement\
